        ...
        */
        ...
        private void Blur(CommandBuffer cmd)
        {
            if (blurType.value != BlurType.None)
            {
                ...
                cmd.SetGlobalVector(ShaderProperties.blurDeltaUV, new Vector2(1f / aoWidth, 0));
                DrawFullScreen(cmd, aoRT, tempRT, material, Pass.Blur); // blur X
                cmd.SetGlobalVector(ShaderProperties.blurDeltaUV, new Vector2(0, 1f / aoHeight));
        ...
        private void UpdateMaterialProperties()
        {
            ...
            #if ENABLE_VR_MODULE && ENABLE_VR
            if (XRSettings.enabled && XRSettings.stereoRenderingMode == XRSettings.StereoRenderingMode.SinglePassInstanced && !renderingInSceneView)
            {
